...
-- PROCEDURE 3: CHECK PERMISSION (Role-Based Access Control)
-- Business Rules:
...
-- PROCEDURE 5: CAST VOTE (Anonymous)
-- Business Rules:
-- - Only voters can vote
...
BEGIN
    ...
    -- Check one vote per voter per election
